     ...
     <form action="" method="POST" >   
        ...
        <div class="col-md-12" display id="datos" <?php if (!$_POST):?>style='display:none;'<?php endif;?>>
            ...
            <div class="form-group">
                ...
                <?=form_dropdown('Tractora_id', $this->Vehiculos_model->get_vehiculos(), set_value('Tractora_id'), 'class="form-control"');?>
                ...
                <?=form_dropdown('Conductor2_id', $this->Viajes_model->get_conductores(), set_value('Conductor2_id'), 'class="form-control"');?>
                    ...
                    <?php endif;?>
                    <?php if($ruta['ndescargas']>0):?>
                        <input name="ndescargas" type="hidden" value="<?=set_value('ncargas')?>"/>   
                        <fieldset>
                            <legend>Descargas anteriores</legend>                        
                            <?php for ($i=0;$i<$ruta['ndescargas'];$i++):?>
                                <div class="form-inline">
                                    <div class="form-group">
